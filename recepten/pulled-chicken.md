...
Kruiden:
- 2 el paprikapoeder (of 1 el paprikapoeder + 1 el gerookt paprikapoeder als je het hebt)
- 2 el komijnpoeder
- 2 tl oregano
- 1 tl chilipoeder
- 1 tl zwarte peper
- 2 tl zout als startpunt — op het einde op smaak brengen
- (optioneel: 2 tl korianderpoeder)
- (optioneel: verse koriander om te serveren — voorkeur: weglaten)
...
- Geen avocado of zure room invriezen.

## Tips / Variaties
- Warme pulled chicken + koude zure room + romige avocado + cheddar = topcombinatie.
- Volkoren wraps zijn prima alternatief voor taco shells.
